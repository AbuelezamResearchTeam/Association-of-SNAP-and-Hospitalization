...
p1<-dat%>%
  ...
  labs(title="Figure 1: Emergency Allotment Extensions (2020 - 2022)")+
  scale_colour_manual(values = c("grey","navyblue"))

p1
fwrite(dat, here("trunk","analysis","EA Ext Fig","snap_flags.txt"))
